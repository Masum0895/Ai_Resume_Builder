...
const TemplateSelector = ({selectedTemplate, onChange}) => {
  ...
  const templates = [
    ...
    },
    {
      id: 'modern',
      name: 'Modern',
      preview: 'Sleek design with strategic use of color and modern format font choices'
    },
    {
      id: 'minimal-image',
      name: 'Minimal Image',
  ...
  return (
    <div className='relative'>
      ...
      {isOpen && (
        <div className='absolute top-full w-xs p-3 mt-2 space-y-3 z-10 bg-white rounded-md brder border-gray-200 shadow-sm'>
