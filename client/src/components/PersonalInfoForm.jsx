import { BriefcaseBusiness, Globe, Mail, MapPin, Phone, User, Share2  } from 'lucide-react'
...
const PersonalInfoForm = ({data, onChange, removeBackground, setRemoveBackGround}) => {
    ...
    const fields = [
        ...
        {key: 'linkedin', label:'LinkedIn Profile', icon: Share2 , type: 'url'},
    ...
    <div>
      ...
      <div className='flex items-center gap-2'>
        <label>
            ...
            <input type='file' accept='image/jpg, image/jpeg, image/png' className='hidden' onChange={(e)=>handleChange('image', e.target.files[0])}/>
        </label>
